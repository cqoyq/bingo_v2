...
BOOST_AUTO_TEST_CASE(t){
	...
	//
	//	thr_id:9d57700,put error, err_code:1,data:00 00 00 00		// all svc thread has exit, it's fail to push data to queue!
	//	thr_id:9d57700,put error, err_code:1,data:00 00 00 00
